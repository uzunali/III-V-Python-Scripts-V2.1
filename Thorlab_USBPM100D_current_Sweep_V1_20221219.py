...
#filename = "221103_Au2Q1_do6209_1pMIR_CL1.5mm_RW2.5um_MIR-6.5X54um-TD2_%s_r2.csv" % power_reading_from[power_index]
#filename = "Test.csv"
filename = "Run1-do5960_EF-Laser_CL-2.0mm_RW-3.0um_dev2_%s_r1.csv" % power_reading_from[power_index]
...
keithley_GPIB.set_voltage("a",0)   
keithley_GPIB.set_current("a",0) 

keithley_GPIB.set_voltage("b",0)
keithley_GPIB.set_current("b",0)  
